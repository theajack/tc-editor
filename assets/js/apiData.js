...
//0 默认样式
  '<div class="api-item-title">默认样式</div>\
    ...
    <editor height="auto" disabled><editor></editor></editor>\
...
//3 功能按钮
  '<div class="api-item-title">功能按钮</div>\
        ...
        <div class="api-show-text">启用全部功能只需要加上<span class="red">buttons="buttons"</span>属性，或者使用<span class="red">buttons="true"</span>或<span class="red">buttons="buttons"</span>。如下所示：</div>\
...
<div class="api-show-text">有以下九个按钮可选(不区分大小写)<span class="red">[fontSizeUp,fontSizeDown,fullScreen,fix,clearColor,clearCode,resetCode,copy,submit]</span>。接下来一一介绍一下它们的作用：</div>\
...
<div class="api-show-text"><span class="red">clearColor</span>：清楚代码的前景色，也就是字体颜色</div>\
...
function getDate(){\n\
    ...
    <div class="api-show-text"><span class="click" onclick=\'Jcode.clearColor(J.id("testEditor"))\'>Jcode.clearColor(J.id("testEditor"))</span></div>\
